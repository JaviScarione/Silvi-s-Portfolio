    ...
    <div className='container__about text-center'>
      <div className='row d-flex justify-content-center top'>
        <div className='col-12 title'>
          <h1 data-aos="fade-right" className='colorblue'>About <span className='colorpink'>Me<span className='colorblue'>!</span></span></h1>
        </div>
        <div className='col col-md-12 col-xl-7 text_about'>
          ...
          <p className='text colordark'>A professional Spanish translator graduated from the University of Cordoba, Argentina. After earning my translation degree, I entered the marketing world to explore my passion for digital marketing, branding, and international business development.</p>
           <h2 className='text colorblue h2'>What <span className='colorpink'>I Can Do</span> for You</h2>
           <p className='text colordark'>I can help you introduce your product or services to Spanish-speaking audiences through Spanish translation services. Whether it is a website, email marketing, or a sales brochure, I ensure that the message sounds natural and achieves maximum impact in the Spanish audience. My role is to facilitate communication and inspire confidence by speaking the client's language.</p>
          <Link to="/services">
      ...
      <div className='data backgroundblue text'>
        <div className='container'>
          <div data-aos="fade-up" className='row justify-content-between'>
            <div className='col-6 col-md-4 item colorlight'>
              <p>+8</p>
            ...
            <div className='col-12 col-md-4 item colorlight'>
              <p>+400</p>
